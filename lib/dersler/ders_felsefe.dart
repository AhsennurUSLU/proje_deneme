...
class FelsefeDers extends StatelessWidget {
  const FelsefeDers({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('9.Sınıf Felsefe Konuları'),
        ),
        body: FelsefePage(),
      ),
    );
...
class FelsefePage extends StatelessWidget {
  FelsefePage({Key? key}) : super(key: key);
